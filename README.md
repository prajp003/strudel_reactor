...
- Snapshots:
	Snapshots capture the graph and DJ controls and convert them into a JSON object, allowing your 'snapshot in time' to be viewed later.
	...
	Snapshots are stored locally in your browser, meaning even if you refresh the page, they will persist.
